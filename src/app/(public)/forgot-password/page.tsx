...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Se o e-mail existir em nossa base, enviaremos um código de redefinição.');
      router.push(`/reset-password?email=${encodeURIComponent(email)}`);
    } catch (error) {
      toast.error(extractErrorMessage(error, 'Erro ao solicitar redefinição de senha.'));
    } finally {
      setLoading(false);
    }
  };
