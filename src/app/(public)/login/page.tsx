...
export default function LoginPage() {
  ...
  // Catches the Google Sign-In redirect fallback (/auth/google-callback) bouncing
  // back here on failure. Reads location.search directly instead of useSearchParams
